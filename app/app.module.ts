...
@NgModule({
    ...
    declarations : [ AppComponent , ContentComponent , DescriptionComponent , addContentComponent , simpleFormComponent , usingFormBuilderComponent ]  , //components that we use in this module
